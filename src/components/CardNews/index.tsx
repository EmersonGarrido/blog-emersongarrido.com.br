  ...
  return (
    <Link href={`/${post.attributes.slug}`}>
      <div
        ...
        className={`${className} hover:-translate-y-2 mb-3 md:mb-0 shadow-sm shadow-black/30 cursor-pointer bg-black/10 hover:bg-black/25 hover:ease-out rounded-b-lg md:h-[410px] h-[315px] md:w-[380px] w-full`}
      >
        <div
          className="h-[160px] p-3 md:w-[371px] w-full rounded-t-lg bg-gradient-to-r from-[#4e1c67] to-[#110E14]"
          style={{
        ...
        <div className="p-4 flex flex-col h-[160px] md:h-[240px] justify-between items-start">
