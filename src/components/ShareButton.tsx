        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute bottom-full right-0 mb-2 bg-[var(--bg-secondary)] rounded-xl shadow-2xl border border-[var(--border-color)] z-50 min-w-[180px] overflow-hidden"
            >
              ...
              <div className="py-1">
                {shareOptions.map((option) => (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 text-[var(--text-secondary)] hover:bg-[var(--bg-tertiary)] hover:text-[var(--text-primary)] transition-colors"
                  >
      ...
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[200] px-4 py-3 bg-[var(--bg-secondary)] text-[var(--text-primary)] border border-[var(--border-color)] rounded-xl shadow-lg flex items-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
